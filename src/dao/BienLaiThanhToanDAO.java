...
public class BienLaiThanhToanDAO implements DAOInterface<BienLaiModel> {
	public static BienLaiThanhToanDAO getInstance() {
		return new BienLaiThanhToanDAO();
	}
	...
	public int insert(BienLaiModel t) {
		...
		try {
			...
			String sql = "INSERT INTO bienlaithanhtoan (maSoCongTo, hoTenChuNha, soDienThoai, diaChi, chiSoCu, chiSoMoi, soTienPhaiTra, thang) "+
...
//		
	...
	public int delete(BienLaiModel t) {
		...
		try {
			...
			String sql = "DELETE from bienlaithanhtoan " + "WHERE maSoCongTo = '" + t.getMaSoCongTo() + "'" + " AND thang = '" + t.getThang() + "'";
			System.out.println(sql);
			ketQua = st.executeUpdate(sql);
	...
	public ArrayList<BienLaiModel> selectAll() {
		...
		try {
			...
			String sql = "SELECT * FROM bienlaithanhtoan";
	...
	public BienLaiModel selectById(BienLaiModel t) {
		...
		try {
			...
			String sql = "SELECT * FROM bienlaithanhtoan WHERE maSoCongTo = '" + t.getMaSoCongTo() + "'";
	...
	public ArrayList<BienLaiModel> selectByCondition(String condition) {
		...
		try {
			...
			String sql = "SELECT * FROM bienlaithanhtoan WHERE " + condition;
